...
variable "requires_compatibilities" { default = ["FARGATE", "EC2"]}
...
variable "container_memoryreservation" { default = "64"}
variable "container_image" { default = "bitnami/apache:latest"}
variable "deployment_maximum_percent" {default = "200"}
variable "deployment_minimum_healthy_percent" {default = "100"}
variable "log_retention_in_days" { default = "365" }
variable "deregistration_delay" { default = "15"}
...
variable "service_discovery_namespace_id" { default = "NONE"}
...
output "aws_cloudwatch_log_group"          {  value = "${aws_cloudwatch_log_group.main.name}" }
